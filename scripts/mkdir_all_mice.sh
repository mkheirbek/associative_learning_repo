...
for ((j=0;i<${#MOUSE[@]};++j)); do
    ...
    session_names=("2_odor_expo" "pre" "post" "ext1" "ext2" "renew" "3odor_pre" "3odor_post" "3odor_pre_rev" "3odor_post_rev" "3odor_catch")
    ...
    #for d in 033019 041019 041119 041519 041619; do
        ...
        rm -r /home/fabios/data/data/odor_ass_learning_2019/results/$DEST_MOUSE/$name/notebooks
        mkdir /home/fabios/data/data/odor_ass_learning_2019/results/$DEST_MOUSE/$name/notebooks
        
    done

    rm -r /home/fabios/data/data/odor_ass_learning_2019/results/$DEST_MOUSE/notebooks
    mkdir /home/fabios/data/data/odor_ass_learning_2019/results/$DEST_MOUSE/notebooks
